...
export default async function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <section>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          >
            ...
            <p className="mt-1 text-xs text-deep-green/80 hover:underline">View users →</p>
          </Link>
          <Link
          ...
          >
            ...
            <p className="mt-1 text-xs text-deep-green/80 hover:underline">Assignments →</p>
          </Link>
          <Link
            href="/admin/modules"
            className="rounded-2xl border border-green-soft bg-light-green/50 p-6 transition-colors hover:bg-light-green"
          >
            ...
            <p className="mt-1 text-xs text-deep-green/80 hover:underline">Manage →</p>
          </Link>
      ...
      {/* 5. Modules Overview Section */}
      <section>
        <ModuleOverviewCard />
      </section>

      {/* 6. Teacher Assignment Section */}
      <section>
